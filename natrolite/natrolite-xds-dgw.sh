...
SPACE_GROUP_NUMBER= 43
UNIT_CELL_CONSTANTS= 18.634 18.788 6.8361 90.0 90.0 90.0
RESOLUTION_SHELLS=4 3 2 1 0.61
EOF
xscale

# Get an MTZ for xia2.compare_merging_stats
pointless -c xdsin temp.ahkl hklout scaled.mtz
...
cat <<EOF > xds.ins
TITL Fdd2
CELL 0.0251 18.634 18.788 6.8361 90.0 90.0 90.0
