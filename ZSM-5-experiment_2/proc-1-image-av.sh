...
do
    ...
    dials.index imported.expt strong.refl detector.fix=distance space_group=Pnma unit_cell="20.2291 20.0053 13.5512 90.000 90.000 90.000"\
      indexing.method=real_space_grid_search stills.indexer=sequences output.experiments=indexed_rsgs.expt output.reflections=indexed_rsgs.refl output.log=dials.index.rsgs.log
      
    dials.index imported.expt strong.refl detector.fix=distance space_group=Pnma unit_cell="20.2291 20.0053 13.5512 90.000 90.000 90.000"\
      indexing.method=low_res_spot_match stills.indexer=sequences n_macro_cycles=2 output.experiments=indexed_lrsm.expt output.reflections=indexed_lrsm.refl output.log=dials.index.lrsm.log
