...
function scale_and_solve2 {
    ...
    dials.scale\
      ...
      deltacchalf.stdcutoff=$STDCUTOFF
...
mkdir -p scale_deltacchalf_3
cd scale_deltacchalf_3/
scale_and_solve2 3
cd ..

mkdir -p scale_deltacchalf_4
cd scale_deltacchalf_4/
scale_and_solve2 4
cd ..
