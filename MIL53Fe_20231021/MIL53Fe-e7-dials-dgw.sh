...
"(MIL53Fe_20231021/experiment_7/) only"
    exit 1
fi
...
do
    ...
    dials.index imported.expt strong.refl detector.fix=distance space_group=P6 unit_cell="12.616 12.616 18.230 90.000 90.000 120" max_lattices=3
    ...
    dials.ssx_integrate stills.expt stills.refl mosaicity_max_limit=0.015\
...
edtools.make_shelx -c 12.616 12.616 18.230 90.000 90.000 120 -w 0.01970 -s "P-62c" -m "C1 Fe1"
